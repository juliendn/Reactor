...
import fr.juliendenadai.reaktor.sample.addcity.AddCityActivity
...
class CityListActivity : ReaktorActivity() {

    private val reaktor by lazyViewModel<CityListViewModel>()
